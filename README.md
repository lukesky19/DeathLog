...
Q: I get the following error: "DeathLog has been compiled by a more recent version of the Java Runtime
(class file version 69.0), this version of the Java Runtime only recognizes class file versions up to 65.0"

A: DeathLog is compiled using Java 25 as part of it's support of 26.1 and beyond. DeathLog still works on older version as long as Java 25 is used.
